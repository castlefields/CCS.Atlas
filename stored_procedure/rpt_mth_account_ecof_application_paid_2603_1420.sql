CREATE OR ALTER PROCEDURE [dbo].[rpt_mth_account_ecof_application_paid_1420]
...
-- Optional group by field (defaults to year_month)
AS
BEGIN
    ...
    -- Build the dynamic SQL for the final result set
