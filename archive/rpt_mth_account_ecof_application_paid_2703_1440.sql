CREATE OR ALTER PROCEDURE [dbo].[rpt_mth_account_ecof_application_paid_2703_1440]
...
BEGIN
    ...
    WHERE
        ...
        AND (@facility_lender IS NULL OR b.facility_lender = @facility_lender)
    GROUP BY 
        b.year_month,
        m.year,
        m.month,
